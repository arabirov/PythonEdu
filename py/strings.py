...
print ("3 Hi! My name is %(name)s, I'm %(age)d years old." % {"name":name, "age":age})	# один из вариантов передачи переменной в print
print ("4 Hi! My name is {}, I'm {} years old.".format(name, age))	# один из вариантов передачи переменной в print
print ("5 Hi! My name is {name}, I'm {age} years old.".format(age=age, name=name))	# один из вариантов передачи переменной в print
